...
export const processDesignPath = {
  flag: 'processDesignPath',
  width: '95%',
  Form: ProcessDesignForm,
  List: ProcessDesignList,
...
export const providerBigProjectPath = {
  list: contextPath + '/provider/dialog2',
};
...
/*
  ...
  撤回流程
 */
export const providerScorePath = {
  flag: 'providerScorePath',
  width: 1100,
...
export const customerCheck12Path = {
  flag: 'customerCheck12Path',
  width: 900,
  List: CustomerCheck12List,
...
export const smallProjectNoPath = {
  flag: 'smallProjectNoPath',
  width: 950,
  Form: SmallProjectNoForm,
  List: SmallProjectNoList,
...
export const projectProtect1Path = {
  flag: 'projectProtect1Path',
  width: 1000,
  Form: ProjectProtect1Form,
  List: ProjectProtect1List,
...
export const smallProjectPath = {
  flag: 'smallProjectPath',
  width: 1200,
  List: SmallProjectList,
...
export const budgetProjecttPath = {
  flag: 'budgetProjecttPath',
  width: 1000,
  List: BudgetProjecttList,
  changeButtonName: '调整',
  AddForm: BudgetProjecttAddForm,
  EditForm: BudgetProjecttAddForm,
...
export const smallBudgetProjectPath = {
  flag: 'smallBudgetProjectPath',
  width: 1000,
  Form: SmallBudgetProjectForm,
  List: SmallBudgetProjectList,
...
export const smallBudgetInPath = {
  flag: 'smallBudgetInPath',
  width: 700,
  Form: SmallBudgetInForm,
  List: SmallBudgetInList,
...
export const smallBudgetOutPath = {
  flag: 'smallBudgetOutPath',
  width: 900,
  Form: SmallBudgetOutForm,
  List: SmallBudgetOutList,
...
export const bigBudgetProjectPath = {
  flag: 'bigBudgetProjectPath',
  width: 1000,
  Form: BigBudgetProjectForm,
  List: BigBudgetProjectList,
...
export const bigBudgetInPath = {
  flag: 'bigBudgetInPath',
  width: 700,
  Form: BigBudgetInForm,
  List: BigBudgetInList,
...
export const bigBudgetCompanyPath = {
  flag: 'bigBudgetCompanyPath',
  width: 800,
  Form: BigBudgetCompanyForm,
  List: BigBudgetCompanyList,
...
export const bigBudgetOutPath = {
  flag: 'bigBudgetOutPath',
  width: 800,
  Form: BigBudgetOutForm,
  List: BigBudgetOutList,
...
export const providerSimplePath = {
  flag: 'providerSimplePath',
  width: 1000,
  Form: ProviderSimpleForm,
  List: ProviderSimpleList,
...
export const smallBudgetRunPath = {
  ...
  width: 900,
  List: SmallBudgetRunList,
  changeButtonName: '调整',
  AddForm: SmallBudgetRunAddForm,
  EditForm: SmallBudgetRunAddForm,
...
export const contractRunPath = {
  flag: 'contractRunPath',
  Form: ContractRunForm,
  List: ContractRunList,
