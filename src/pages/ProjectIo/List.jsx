...
export default () => {
  const columns = [
    ...
    { title: '影响收支', dataIndex: 'haveInOut', valueType: 'text', hideInSearch: true },
    { title: '日期', dataIndex: 'ioDate', valueType: 'text', hideInSearch: true },
    { title: '往来款', dataIndex: 'money', valueType: 'text', hideInSearch: true },
