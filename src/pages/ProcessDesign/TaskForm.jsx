...
export default (props) => {
  ...
  useEffect(async () => {
    form.reset();
    form
      .query('*(taskType,taskKey)')
      .map((field) => (field.pattern = 'disabled'));
    if (data) {
      ...
      form.setInitialValues({
        ...
        taskType: node.type,
        taskKey: node.id,
        taskName: (node.text && node.text.value) || '',
        haveEditForm: '否',
        haveBackFirst: '是',
      });
    }
      ...
      <Form form={form} className={styles.placeholder}>
        <SchemaField>
          <SchemaField.Void
            ...
            x-component-props={{ labelCol: 4, wrapperCol: 18 }}
          >
            <SchemaField.String
              name="taskType"
              required
