import { projectPowerPath } from '../../utils'
import { BaseProTableProcess } from '../../components'

export default () => {
  const columns = [
    { title: '被授权项目', dataIndex: 'projectName', valueType: 'text' },
    ...
    { title: '是否立项', dataIndex: 'status', valueType: 'text' },
  ]

  return <BaseProTableProcess path={projectPowerPath} columns={columns} search={true}/>
}
