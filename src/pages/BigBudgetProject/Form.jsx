...
export default (props) => {
  ...
  useEffect(async () => {
    form.query('*(displayName,deptName,createDatetime,taskCode,property,protectRate,invoiceRate,projectRate,totalCost,endMoney,inChangeMoney,outChangeMoney)').forEach(field => {
    ...
    <Form form={form} labelWidth={110} className={styles.placeholder}>
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          ...
          />
          <SchemaField.String name="protectRate" x-decorator="FormItem" title="质保金比例" x-component="Input"/>
          <SchemaField.String name="invoiceRate" x-decorator="FormItem" title="税率" x-component="Input"/>
          <SchemaField.String name="projectRate" x-decorator="FormItem" title="预计毛利率" x-component="Input"/>
          <SchemaField.String name="contractCode" required x-decorator="FormItem" title="合同号" x-component="Input"/>
          <SchemaField.Number name="contractMoney" required x-decorator="FormItem" title="合同金额" x-component="NumberPicker"/>
          <SchemaField.String name="contractName" required x-decorator="FormItem" title="合同名称" x-component="Input"/>
          <SchemaField.String name="totalCost" x-decorator="FormItem" title="成本预算" x-component="Input"/>
        ...
        >
          <SchemaField.Object>
            ...
            <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{ title: '收回/结束时间', align: 'center' }}>
              <SchemaField.String
