...
const SchemaField = createSchemaField({
  components: {
    ...
    LoadingButton, InputButton, NumberPicker, Select, DatePicker, MyCard,
  },
})
...
export default (props) => {
  ...
  useEffect(async () => {
    form.query('*(displayName,deptName,createDatetime,taskCode,property,wbs,type)').forEach(field => {
    ...
    <Form form={form} labelWidth={110} className={styles.placeholder}>
      <SchemaField>
        ...
        <SchemaField.Void x-component="MyCard" x-component-props={{ title: '收付款信息' }}>
          <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
            <SchemaField.String name="registeDate" required x-decorator="FormItem" title="日期" x-component="DatePicker"/>
