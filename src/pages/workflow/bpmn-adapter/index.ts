...
enum BpmnElements {
  ...
  PARALLEGATEWAY = 'bpmn:parallelGateway',
  USER = 'bpmn:userTask',
...
BpmnAdapter.shapeConfigMap.set(BpmnElements.EXCLUSIVEGATEWAY, {
  width: ExclusiveGatewayConfig.width,
  height: ExclusiveGatewayConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.PARALLEGATEWAY, {
