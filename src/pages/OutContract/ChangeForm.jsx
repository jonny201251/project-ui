...
export default (props) => {
  ...
  useEffect(async () => {
    form.query('*(displayName,deptName,createDatetime,taskCode,property,contractCode,costType,costRate)').forEach(field => {
    ...
    <Form form={form} labelWidth={110} className={styles.placeholder}>
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          ...
          <SchemaField.String
            name="providerName" required title="相对方名称" x-decorator="FormItem" x-decorator-props={{ gridSpan: 2 }}
          ...
          <SchemaField.Number
            name="endMoney" required x-decorator="FormItem" title="结算金额" x-component="NumberPicker"/>
          <SchemaField.String
