...
export default (props) => {
  ...
  useEffect(async () => {
    form
      .query(
        '*(displayName,deptName,createDatetime,customerProperty,startScore,startResult,endScore,endResult)',
      )
      .forEach((field) => {
  ...
  const onClick = () => {
    let dialog2 = FormDialog(
      { footer: null, keyboard: false, maskClosable: false, width: 700 },
      (form2) => {
        return (
          <>
            <DialogList
