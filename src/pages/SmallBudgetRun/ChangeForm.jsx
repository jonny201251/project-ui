import { DatePicker, Form, FormDialog, FormGrid, FormItem, FormLayout, Input, Radio, Select } from '@formily/antd'
...
const SchemaField = createSchemaField({
  components: {
    ...
    DatePicker, File, Select, Radio, OnlyButton,
  },
})
...
export default (props) => {
  ...
  useEffect(async () => {
    form.query('*(displayName,deptName,createDatetime,taskCode,name)').forEach(field => {
      ...
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          <SchemaField.String
            ...
            name="comment" required title="调整说明" x-decorator="FormItem" x-component="Input.TextArea"
