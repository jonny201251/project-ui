    ...
    <Form form={form} labelWidth={110} className={styles.placeholder}>
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          ...
          <SchemaField.String
            name="costType" required title="费用类型" x-decorator="FormItem" x-component="Select"
          ...
          >
            <SchemaField.Object>
              ...
              <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{ title: '公司名称', align: 'center' }}>
                <SchemaField.String name="companyName" x-decorator="FormItem" x-component="Input"/>
              </SchemaField.Void>
